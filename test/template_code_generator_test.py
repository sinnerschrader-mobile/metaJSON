...
class TestTemplateCodeGenerator(unittest.TestCase):
    ...
    def test_read_template(self):
        expected_jsons = ['./metajson/templates/iOS/_header.h.mustache', './metajson/templates/iOS/_source.m.mustache', './metajson/templates/iOS/header.h.mustache', './metajson/templates/iOS/source.m.mustache']
